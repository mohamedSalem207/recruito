...
export default function Candidate({
  ...
  return (
    ...
    >
      <div className="relative mb-3 flex flex-col items-center justify-center gap-1.5 border-b border-[#E6E8EC4F] pb-3 lg:mb-7 lg:pb-7">
        {verified && (
          <Image
      ...
      <div className="flex flex-wrap items-start justify-center gap-2.5">
        {skills.map((skill, i) => (
          <div className="rounded-[35px] bg-[#E6E8EC4F] px-3.5 py-2 text-text">
            {skill}
          </div>
        ))}
      </div>
